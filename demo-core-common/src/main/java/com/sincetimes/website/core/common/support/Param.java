 ...
 * 获取值：Code code = param.get("code"); //这里会自动转换类型，无需添加(Code)显示强转
 */
public class Param implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final String KEY_SINGLE = "KEY_SINGLE_PARAM"; // 当只传入一个数据项时，自动用此KEY值，简化操作
	...
	/**
	 * 有参构造函数 内容为Key：Val形式 例如：new Param("sn", sn, "param", param)
	 */
