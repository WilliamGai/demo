...
import com.sonic.website.core.common.extension.UnsafeStringWriter;
...
public class Util {
    ...
    public static String tranString(String s, String srcCharset, String tarCharset) {
        ...
        try {
            ...
            LogCore.BASE.error("tranString err:s={},srccharset = {}, tarCharset={}", s, srcCharset, tarCharset,
                    e);
            return null;
        }
    }
    ...
    public static <T> T swap(Object[] arr, int i, int j) {
        Object tmp = arr[i];
        arr[i] = arr[j];
        arr[j] = tmp;
        return (T) tmp;
