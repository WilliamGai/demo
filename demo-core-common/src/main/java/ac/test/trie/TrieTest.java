...
public class TrieTest {
    ...
    public void bug5InGithubReportedByXCurry() {
        ...
        trie.addKeyword("b枚rk眉");
        Collection<Emit> emits = trie.parseText("TurninG OnCe AgAiN B脰RK脺");
    ...
    public void unicodeIssueBug8ReportedByDwyerk() {
        String target = "L陌KE THIS"; // The second character ('陌') is Unicode, which was read by AC as a 2-byte char
        Trie trie = new Trie().caseInsensitive().onlyWholeWords();
